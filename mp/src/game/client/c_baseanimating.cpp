...
{
#ifdef FF	// allow overriding of materials for any entity derived from C_BaseAnimating
...
#ifdef FF	// stop overriding so every model isn't drawn with the override material
