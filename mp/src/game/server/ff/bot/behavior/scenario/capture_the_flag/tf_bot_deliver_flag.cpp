...
ConVar ff_mvm_bot_allow_flag_carrier_to_fight( "ff_mvm_bot_allow_flag_carrier_to_fight", "1", FCVAR_CHEAT );

ConVar ff_mvm_bot_flag_carrier_interval_to_1st_upgrade( "ff_mvm_bot_flag_carrier_interval_to_1st_upgrade", "5", FCVAR_CHEAT );
ConVar ff_mvm_bot_flag_carrier_interval_to_2nd_upgrade( "ff_mvm_bot_flag_carrier_interval_to_2nd_upgrade", "15", FCVAR_CHEAT );
ConVar ff_mvm_bot_flag_carrier_interval_to_3rd_upgrade( "ff_mvm_bot_flag_carrier_interval_to_3rd_upgrade", "15", FCVAR_CHEAT );

ConVar ff_mvm_bot_flag_carrier_health_regen( "ff_mvm_bot_flag_carrier_health_regen", "45.0f", FCVAR_CHEAT );
...
ActionResult< CTFBot >	CTFBotDeliverFlag::OnStart( CTFBot *me, Action< CTFBot > *priorAction )
{
	...
	{
		m_upgradeLevel = 0;
		m_upgradeTimer.Start( ff_mvm_bot_flag_carrier_interval_to_1st_upgrade.GetFloat() );
		if ( TFObjectiveResource() )
		{
	...
	if ( TFGameRules()->IsMannVsMachineMode() && m_upgradeLevel != DONT_UPGRADE )
	{
		...
		if ( m_upgradeTimer.IsElapsed() )
		{
			...
			if ( m_upgradeLevel < maxLevel )
			{
				...
				//---------------------------------------
				case 1:
					m_upgradeTimer.Start( ff_mvm_bot_flag_carrier_interval_to_2nd_upgrade.GetFloat() );
